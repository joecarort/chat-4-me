...
AS $$
DECLARE
  project_url TEXT := 'https://xjwgotknprsptlpltwes.supabase.co';
  service_role_key TEXT := 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Inhqd2dvdGtucHJzcHRscGx0d2VzIiwicm9sZSI6InNlcnZpY2Vfcm9sZSIsImlhdCI6MTcwNTI4ODQ1MSwiZXhwIjoyMDIwODY0NDUxfQ.AS4x99vlr2-RpVvTYw6N8ROyA9lCQb2uwLr-AoDYb0Q'; -- full access needed for http request to storage
